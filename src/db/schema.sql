...
CREATE TABLE IF NOT EXISTS orders (
  ...
  store_name TEXT DEFAULT 'China Palace',
  first_name TEXT NOT NULL,
  last_name TEXT,
  ...
  status TEXT DEFAULT 'processing' CHECK (status IN ('processing', 'pending', 'confirmed', 'preparing', 'ready', 'delivered', 'cancelled', 'complete')),
  comment TEXT,
...
CREATE TRIGGER IF NOT EXISTS update_store_config_updated_at 
